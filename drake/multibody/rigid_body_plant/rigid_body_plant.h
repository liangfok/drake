...
class RigidBodyPlant : public LeafSystem<T> {
 public:
  ...
  /// @name System output port description accessors.
  /// These are accessor methods for obtaining descriptions of this
  /// RigidBodyPlant's output ports. See this class's description for detals
  /// about these ports.
  ///@{
