...
//   EXPECT_THROW(GetROSParameter<double>(node_handle, "non_existent_parameter"),
//     std::runtime_error);
// }
...
GTEST_TEST(DrakeRosParameterServerTest, TestGetDouble) {
  ...
  double value = 0;
  EXPECT_NO_THROW(
      value = GetROSParameter<double>(node_handle, "double_parameter_name"));
...
//   std::string value{};
//   EXPECT_NO_THROW(
//       value = GetROSParameter<std::string>(node_handle,
...
//   int value{};
//   EXPECT_NO_THROW(
//       value = GetROSParameter<int>(node_handle,
//                                            "int_parameter_name"));
...
//   EXPECT_NO_THROW(
//       true_value = GetROSParameter<bool>(node_handle,
//                                          "bool_parameter_name_true"));
//   EXPECT_NO_THROW(
//       false_value = GetROSParameter<bool>(node_handle,
//                                          "bool_parameter_name_false"));
